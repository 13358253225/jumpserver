# Generated by Django 3.1.13 on 2022-01-11 11:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_start', models.DateTimeField(auto_now_add=True, verbose_name='Date start')),
                ('timedelta', models.FloatField(default=0.0, null=True, verbose_name='Time')),
                ('execution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='task', to='assets.accountbackupplanexecution', verbose_name='Account backup plan execution')),
            ],
            options={
                'verbose_name': 'Account backup plan task',
            },
        ),
    ]
